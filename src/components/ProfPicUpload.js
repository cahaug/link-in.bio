...
const ProfPicUpload = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const addingToProfile = await axios.put(`http://link-in-bio.limited/l/uploadProfilePicture/${userId}`, formData, {headers:{'Content-Type': 'multipart/form-data', authorization:token}})
