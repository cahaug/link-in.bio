...
const LandingPage = () => {
    ...
    return (
        <div>
            ...
            {['4','5','6'].includes(currentTime[currentTime.length - 1])? <h2 className="specialText">Social Networking,<br/>Reinvented<br/></h2>:null}
            {['7','8','9','0'].includes(currentTime[currentTime.length - 1])? <h2 className="specialText">Big Data<br/>with a<br/>Small Price<br/></h2>:null}
            <br />
