    ...
    const submitChange = async (event) => {
        ...
        try {
            ...
            if(validationRes === true){
                ...
                const changePwResolved = await axios.put('http://link-in-bio.limited/auth/SettingsCPW', { email:email, password:password, newPassword:newPassword }, {headers:{authorization:token}})
