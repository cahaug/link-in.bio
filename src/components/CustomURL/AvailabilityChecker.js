...
const AvailabilityChecker = () => {
    ...
    const submitCheckChosenCustom = (event) => {
        ...
        if(hasNoIllegalChars(intermediate) === true){
            ...
            return axios.post('http://link-in-bio.limited/l/checkCustom', {customURL:secondaryIntermediate}, {headers:{authorization:token}})
            .then(res => {
    ...
    const submitChangeCustom = (event) => {
        ...
        return axios.put('http://link-in-bio.limited/l/putCustom', { userId: userId, listId: listId, customURL:customURL }, { headers: {authorization:token} })
        .then((res) => {
