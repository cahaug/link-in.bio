    ...
    if(isLoading===true){
        ...
        return(
            <div>
                ...
                <p>You won't ever see a cookie disclaimer on our website ❌🍪❌,<br />because we only use legitimate interest cookies for registration and replying to customer messages, not our core functionalities. 👍 </p><br/>
